...
[รูปที่ 4](images/normals/02-04a.png)
...
[รูปที่ 7](images/normals/02-07.png)
...
ตรง Function _process(delta) นั้น จะถูกเรียกเรื่อยๆ เราจะเช็คปุ่ม ซ้าย, ขวา, บน และ ล่าง ถ้ามี เราจะเพิ่มความเร็ว velocity จากนั้น ถ้ามีความเร็วมากกว่า 0 (velocity.length() > 0), เราจะ translate ไปตามความเร็ว
